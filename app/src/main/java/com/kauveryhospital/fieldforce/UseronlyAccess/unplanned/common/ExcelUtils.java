...
public class ExcelUtils {
    ...
    private static void setHeaderRow() {
        ...
        cell.setCellValue("Employe Id");
        cell.setCellStyle(headerCellStyle);

        cell = headerRow.createCell(1);
        cell.setCellValue("Visitdate");
        cell.setCellStyle(headerCellStyle);
        ...
        cell.setCellValue("CheckinTime");
        cell.setCellStyle(headerCellStyle);

        cell = headerRow.createCell(5);
        cell.setCellValue("Checkouttime");
        cell.setCellStyle(headerCellStyle);
        ...
        cell.setCellValue("VisitPurpose");
        cell.setCellStyle(headerCellStyle);
    ...
    private static void fillDataIntoExcel(List<ContactResponse> dataList) {
        for (int i = 0; i < dataList.size(); i++) {
            ...
            cell.setCellValue(dataList.get(i).getEmpname());

            cell = rowData.createCell(1);
            cell.setCellValue(dataList.get(i).getVisitdate());
            ...
            cell.setCellValue(dataList.get(i).getCheckin());

            cell = rowData.createCell(5);
            cell.setCellValue(dataList.get(i).getCheckouttime());

            cell = rowData.createCell(6);
            cell.setCellValue(dataList.get(i).getRemarks());

            cell = rowData.createCell(7);
            cell.setCellValue(dataList.get(i).getVisit_purpose());
           /* if (dataList.get(i).getPhoneNumberList() != null) {
                ...
                cell.setCellValue("No Phone Numberss");
            }*/
        }
    }
