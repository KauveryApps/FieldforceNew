...
public class Row implements Serializable
{
    ...
    @SerializedName("emp_mappingid")
    @Expose
    private String emp_mappingid;
   ...
   public String getEmp_mappingid(){
        return emp_mappingid;
   }
   public void setEmp_mappingid(String emp_mappingid){
        this.emp_mappingid=emp_mappingid;
   }
}
