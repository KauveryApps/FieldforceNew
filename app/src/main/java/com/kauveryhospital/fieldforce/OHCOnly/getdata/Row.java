...
public class Row implements Serializable
{
    ...
    @SerializedName("work_startid")
    @Expose
    private  String work_startid;
    ...
    @SerializedName("jointcall2")
    @Expose
    private String jointcall2;
    @SerializedName("jointcall3")
    @Expose
    private String jointcall3;
    @SerializedName("visitdetailid")
    @Expose
    ...
    @SerializedName("truncdate")
    @Expose
    private String truncdate;
    private final static long serialVersionUID = -1115710044781218643L;

    public String getTruncdate() {
        return truncdate;
    }

    public void setTruncdate(String truncdate) {
    ...
    public String getJointcall2() {
        return jointcall2;
    }

    public void setJointcall2(String jointcall2) {
        this.jointcall2 = jointcall2;
    }

    public String getJointcall3() {
        return jointcall3;
    }

    public void setJointcall3(String jointcall3) {
        this.jointcall3 = jointcall3;
    }
   ...
   public String getWork_startid(){
        return  work_startid;
   }
   public void setWork_startid(String work_startid){
        this.work_startid=work_startid;
   }
